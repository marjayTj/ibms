...
<form action="sql_edit_residential_details.php" method="POST">
	...
	<button type="submit" name="submit" value="<?php echo $resid ?>" class="btn btn-info" style="float: right; margin-right:10px;">Edit Residential Details</button>
</form>
